...
## 💼 Business Context
Drawing from my **6+ years of experience** as a Compliance Manager, I designed this system to automate the detection of "Red Flags" that typically require intensive manual review. This solution focuses on **scalability** and **detection accuracy**.
